//
//  LocalCityForecastFullViewController.swift
//  BeeWheather
//
...
class LocalCityForecastFullViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate {
